...
var link="http://api.imagendigital.com/v2/cocinadelirante/node.json/339fd1e0444ddbbd4d4528d8df161108?&fields=image.styles.square_circle&type=receta&limit=10&offset=16";
...
//Meter API Imagenes
        ...
        var imagen = document.getElementsByClassName("ImgN")[0];    
        document.getElementsByClassName("ImgN")[0].innerHTML='<img src="' + Nice.data[0].image.styles.square_circle + '" alt="">';

        var imagen2 = document.getElementsByClassName("ImgN")[1];    
        document.getElementsByClassName("ImgN")[1].innerHTML='<img src="' + Nice.data[1].image.styles.square_circle + '" alt="">';
        
        var imagen3 = document.getElementsByClassName("ImgN")[2];    
        document.getElementsByClassName("ImgN")[2].innerHTML='<img src="' + Nice.data[2].image.styles.square_circle + '" alt="">';

        var imagen4 = document.getElementsByClassName("ImgN")[3];    
        document.getElementsByClassName("ImgN")[3].innerHTML='<img src="' + Nice.data[3].image.styles.square_circle + '" alt="">';

        var imagen5 = document.getElementsByClassName("ImgN")[4];    
        document.getElementsByClassName("ImgN")[4].innerHTML='<img src="' + Nice.data[4].image.styles.square_circle + '" alt="">';

        var imagen6 = document.getElementsByClassName("ImgN")[5];    
        document.getElementsByClassName("ImgN")[5].innerHTML='<img src="' + Nice.data[5].image.styles.square_circle + '" alt="">';

        var imagen7 = document.getElementsByClassName("ImgN")[6];    
        document.getElementsByClassName("ImgN")[6].innerHTML='<img src="' + Nice.data[6].image.styles.square_circle + '" alt="">';

        var imagen8 = document.getElementsByClassName("ImgN")[7];    
        document.getElementsByClassName("ImgN")[7].innerHTML='<img src="' + Nice.data[7].image.styles.square_circle + '" alt="">';

        var imagen9 = document.getElementsByClassName("ImgN")[8];    
        document.getElementsByClassName("ImgN")[8].innerHTML='<img src="' + Nice.data[8].image.styles.square_circle + '" alt="">';

        var imagen10 = document.getElementsByClassName("ImgN")[9];    
        document.getElementsByClassName("ImgN")[9].innerHTML='<img src="' + Nice.data[9].image.styles.square_circle + '" alt="">';
