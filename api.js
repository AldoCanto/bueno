...
//Meter API en la Tarjeta
        ...
        document.getElementsByClassName("category")[0].innerHTML= api.data[1].taxonomy.name;

        var title2 = document.getElementsByClassName("title")[0];    
        document.getElementsByClassName("title")[0].innerHTML= api.data[1].title;
        ...
        document.getElementsByClassName("autor")[0].innerHTML= api.data[1].author.name;
        
        //Card 3

        var category3 = document.getElementsByClassName("category")[1];    
        document.getElementsByClassName("category")[1].innerHTML= api.data[2].taxonomy.name;

        var title3 = document.getElementsByClassName("title")[1];    
        document.getElementsByClassName("title")[1].innerHTML= api.data[2].title;

        let time2 =api.data[2].created;
        ...
        document.getElementsByClassName("autor")[1].innerHTML= api.data[2].author.name;


        //Card 4

        var category4 = document.getElementsByClassName("category")[2];    
        document.getElementsByClassName("category")[2].innerHTML= api.data[3].taxonomy.name;

        var title4 = document.getElementsByClassName("title")[2];    
        document.getElementsByClassName("title")[2].innerHTML= api.data[3].title;

        let time3=api.data[3].created;
        ...
        document.getElementsByClassName("autor")[2].innerHTML= api.data[3].author.name;
        

        //Card 5

        var category5 = document.getElementsByClassName("category")[3];    
        document.getElementsByClassName("category")[3].innerHTML= api.data[4].taxonomy.name;

        var title5 = document.getElementsByClassName("title")[3];    
        document.getElementsByClassName("title")[3].innerHTML= api.data[4].title;

        let time4=api.data[4].created;
        ...
        document.getElementsByClassName("autor")[3].innerHTML= api.data[4].author.name;
        

        //Card 6

        var category6 = document.getElementsByClassName("category")[4];    
        document.getElementsByClassName("category")[4].innerHTML= api.data[5].taxonomy.name;

        var title6 = document.getElementsByClassName("title")[4];    
        document.getElementsByClassName("title")[4].innerHTML= api.data[5].title;

        let time5=api.data[5].created;
        ...
        document.getElementsByClassName("autor")[4].innerHTML= api.data[5].author.name;
        

          //Card 1        

          var category = document.getElementsByClassName("category")[5];    
          document.getElementsByClassName("category")[5].innerHTML= api.data[0].taxonomy.name;
  
          var title = document.getElementsByClassName("title")[5];    
          document.getElementsByClassName("title")[5].innerHTML= api.data[0].title;
          ...
          document.getElementsByClassName("autor")[5].innerHTML= api.data[0].author.name;
